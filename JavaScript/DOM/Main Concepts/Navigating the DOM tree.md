...
- `<title>`: элементный узел, содержащий текстовый узел "DOM Tutorial".
- `<h1>`: элементный узел, содержащий текстовый узел "DOM Lesson one".
- `<p>`: элементный узел, содержащий текстовый узел "Hello world!".
